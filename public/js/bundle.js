...
/*eslint-disable*/
var resizeImage = function resizeImage(image, targetWidth, targetHeight) {
  ...
  filerdr.onload = function (evt) {
    ...
    img.onload = function () {
      ...
      ctx.drawImage(img, startWidth, // Crop start width
...
function showSlides() {
  ...
  for (i = 0; i < slides.length; i++) {
    slides[i].style.display = 'none'; // slides[i].className = 'mySlides';
  }
  ...
  slides[slideIndex - 1].style.display = 'block'; // slides[slideIndex - 1].className = 'mySlides--active';

  dots[slideIndex - 1].className += ' active';
  setTimeout(showSlides, 3500); // Change image every 2 seconds
}

var autoShowSlides = function autoShowSlides() {
  showSlides();
};

exports.autoShowSlides = autoShowSlides;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51Ld4uoD1GqQWWhwRGnLuPGmXovaNOejjzfPnzX0WCHs64o7ogdC6SnkY8mhUh3F9nM0QHUlVqjX6HNkpVQsl0Yjt00qf1znvg8');
            _context.prev = 1;
            _context.next = 4;
...
var pfpUploadInput = document.getElementById('photo');
...
if (userDataForm) {
  pfpUploadInput.addEventListener('change', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var inputPic, userPhotoElement;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              inputPic = pfpUploadInput.files[0];

              if (inputPic) {
                userPhotoElement = document.querySelector('.form__user-photo');
                (0, _resizeImage.resizeImage)(inputPic, 500, 500, userPhotoElement);
              }
